 ...
 * @todo Do not use properties for configuration values
 * @todo Maybe this class will be better as an CLI/API hybrid controller?
 */
class clusters extends base
{
    ...
    /**
     * Initializes Cluster Controller
     */
    public function init()
    {
        ...
        Router::registerRoutes(array(
            ...
            "/api/v1/cluster/subscriptions" => "$path\\subscriptions"
        ));
    ...
    /**
     * Communicates with other cluster nodes to assert
     * self position on the network
     * @todo Proper output
     * @return null
     */
    ...
    /**
     * HTTP client wrapper for inter-cluster communication
     * @param  string $method
     * @param  string $address
     * @param  string $endpoint
     * @param  array  $data     Optional.
     * @param  bool   $secret   Optional. Defaults to false.
     * @return mixed
     */
    ...
    public function login()
    {
        ...
        if (!$node_uri || $node_uri == elgg_get_site_url() || "https://$node_uri" == elgg_get_site_url() || "http://$node_uri" == elgg_get_site_url()) {
            return true;
        }
    ...
    /**
     * Inter-node sync user carrousels
     * @param  mixed $user
     * @return bool|null
     */
