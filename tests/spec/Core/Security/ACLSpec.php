...
class ACLSpec extends ObjectBehavior {
    ...
    function it_should_allow_write_for_own_entities(Entity $entity){
      $this->mock_session(true);
    ...
    function it_should_trigger_acl_write_event(Object $entity){
      $this->mock_session(true);
    ...
    function it_should_return_false_on_acl_interact_event(Object $entity){
      $this->mock_session(true);
