<?php
	 ...
	 * @link http://www.marcus-povey.co.uk/
 	 */
        ...
        global $MULTI_DB;
        $MULTI_DB = new stdClass(); //make a database class for caching etc
		...
		ArrayAccess // Override for array access
	{
		...
		public function getID() {return $this->domain;  } // ID now is the same as DOMAIN
		 ...
		 */
 		public function save()
 		{
 			...
 			$url = $this->getDomain();//mysql_real_escape_string($this->getDomain());
