...
.archive-batch-3 .batch-thumbnails.image-thumbnail{
	margin:0;
	float: left;
	width: 32%;
	padding: 1px;
...
.archive-batch-3 .batch-thumbnails.image-thumbnail:first-of-type{
	width:65%;
}
.archive-batch-1{
	height:auto;
...
.archive-batch-1 .batch-thumbnails{
	width:100%;
}
