...
<div id="dashboard_navigation">
    ...
    if($num == 0){
    ?>
    	<li><a href="<?php echo $vars['url']; ?>messages/inbox/<?php echo $_SESSION['user']->username; ?>">Messages <span style="color:#FF0000">[0 new]</span></a></li>  
    <?php }else{ ?>
    	<li><a href="<?php echo $vars['url']; ?>messages/inbox/<?php echo $_SESSION['user']->username; ?>">New messages <span style="color:#FF0000">[<?php echo $num; ?> new]</span></a></li>
    <?php } ?>
