...
tinymce.PluginManager.add('media', function(editor, url) {
	var urlPatterns = [
		{regex: /youtu\.be\/([\w\-.]+)/, type: 'iframe', w: 720, h: 576, url: '//www.youtube.com/embed/$1', img: '//img.youtube.com/vi/$1/hqdefault.jpg'},
		{regex: /youtube\.com(.+)v=([^&]+)/, type: 'iframe', w: 720, h: 576, url: '//www.youtube.com/embed/$2', img: '//img.youtube.com/vi/$2/hqdefault.jpg'},
