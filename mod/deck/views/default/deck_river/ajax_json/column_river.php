...
// Get callbacks
$tab_guid = get_input('tab', 'default');
$column_guid = get_input('column', false);
$prev = get_input('pagination_previous',null);
$next = get_input('pagination_next',null);
...
$params = array('pagination'=>array('previous'=>$prev, 'next'=>$next));
$data = $column->getRiverData($params);
$jsonexport['results'] = $data['data'];
$jsonexport['pagination'] = $data['pagination'];
$jsonexport['network'] = $account->network;
