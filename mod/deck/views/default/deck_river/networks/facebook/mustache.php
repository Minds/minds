...
<script id="elgg-river-facebook-template" type="text/template">
	
	<li class="elgg-list-item item-facebook-{{id}}" data-object_id="{{object_id}}" data-id="{{id}}" data-username="{{from.name}}">
		...
		<div class="elgg-image-block minds-river-header clearfix">
			<div class="elgg-image">
				<div class="elgg-avatar elgg-avatar-small">
					...
					<a href="{{}}" class="">
						<img alt="{{from.name}}" title="{{from.name}}" class="" style="background: url(https://graph.facebook.com/{{from.id}}/picture) no-repeat;">
					</a>
				</div>
		...
		<div class="minds-river-message">
			{{{message}}}
			{{#showOnFacebook}}
			<a target="_blank" href="https://facebook.com/{{id}}">{{showOnFacebook}}</a>
			{{/showOnFacebook}}
		</div>
		{{#link}}
		
		<div class="minds-river-attachments" data-mainimage="{{full_picture}}" data-title="{{name}}" data-url="{{link}}" data-description="{{description}}" data-editable="true">
			{{#full_picture}}
			...
			<div class="elgg-image">
				<div class="elgg-avatar elgg-avatar-small">
					<div class="facebook-{{#from.category}}page{{/from.category}}{{^from.category}}user{{/from.category}}-info-popup info-popup" title="{{from.id}}">
						<img title="{{from.name}}" alt="{{from.name}}" src="https://graph.facebook.com/{{from.id}}/picture?width=24&height=24" width="24" height="24">
					</div>
				</div>
			</div>
			<div class="elgg-body">
	...
	<ul class="elgg-body">
		<li id="fb-{{uid}}-info-profile">
			<div class="elgg-avatar elgg-avatar-large float prm">
				<a href="https://www.facebook.com/{{username}}" title="{{first_name}} {{last_name}}" rel="nofollow" target="_blank">
