...
$avatar = elgg_view('output/img', array(
	'src' => $account->icon ? $account->icon : 'https://graph.facebook.com/' . $account->id . '/picture', // facebook group use icon, else this is a user account
	'alt' => $account->name,
