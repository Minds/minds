...
$french = array(
	...
	'deck_river:tumblr:choose:account' => "Choisissez le compte Tumblr pour cette colonne :",
	'deck_river:tumblr:dashboard' => "Flux d'accueil",
	'deck_river:tumblr:like' => "Votre like a été pris en compte par Tumlbr !",

	// LinkedIn
	'deck_river:networklinkedin' => 'LinkedIn',
	'deck_river:linkedin:feed:network' => "Flux d'accueuil",
	'deck_river:linkedin:feed:mine' => 'Mes nouvelles',
	'deck_river:linkedin:CONN' => "a une nouvelle relation",
	'linkedin:connexions' => "connexions",
	'linkedin:distance' => "niveau de relation",
	'linkedin:summary' => "Résumé",
	'linkedin:updates:commented' => "Votre commentaire a été posté.",
	'linkedin:updates:favorited' => "Vous aimez maintenant cette publication",
	'linkedin:companies:follow_none' => "LinkedIn indique que vous ne suivez aucune companies.",
