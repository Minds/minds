...
$finnish = array(
	// menu
	'admin:developers' => 'Suunnittelijat',
	'admin:developers:settings' => 'Suunnittelija-asetukset',
	'admin:developers:preview' => 'Teeman esikatselu',
	'admin:developers:inspect' => 'Tutki',
