		...
		<div>
			<form method="post" action="<?php echo $action; ?>">
				...
				<div style="float:left;margin:18px 0 0 20px;">
					<img src="<?php echo $CONFIG->wwwroot; ?>mod/<?php echo $CONFIG->pluginname; ?>/views/default/modules/checkout/paypal_ipn/images/paypal_logo.gif">
				</div>
				<div class="clear"></div>
			</form>
		</div>
