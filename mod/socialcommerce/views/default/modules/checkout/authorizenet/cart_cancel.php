<?php
	...
	/**
	 * Elgg checkout - authorize.net - cancellation page
	 * 
	...
	gatekeeper();
 	...
 	$body = elgg_echo('cart:cancel:authorizecontent');
        $body .= "<br>".$_SESSION['reason']."<br>".$_SESSION['full_error_message'];
 	$back_text = elgg_echo('checkout:back:text');
	$action = $CONFIG->wwwroot."pg/{$CONFIG->pluginname}/{$_SESSION['user']->usernaem}/cart";
	$area2 = <<<EOF
		{$body}
