<?php
	...
	if (!in_array($size,array('large','medium','small','tiny','master','topbar')))
		$size = "medium";
	if($stores->ftp_upload_allow){	
		
		$http_image_path = $stores->ftp_http_path.$CONFIG->pluginname."/".$stores->owner_guid."/".$stores->guid.$size.".jpg";
		$success = false;
		if($contents = file_get_contents($http_image_path)){
			$success = true;
		}		
	}else{
		$success = false;
