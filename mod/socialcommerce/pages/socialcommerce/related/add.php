<?php
	...
	/**
	 * Elgg social commerce - Add related product page
	 * 
	...
	$title = elgg_echo('add:related:products:services');
	...
	if($permission == 1) {
		...
		$area2 = elgg_view("{$CONFIG->pluginname}/forms/edit_related_products",array('product'=>$product));
	} else {
