...
/*****************************************************************************\
	...
	$title = elgg_echo('socialcommerce:multi_prod_ver:version');
	elgg_push_breadcrumb($title);
	
	$version_guid = (int) get_input('version_guid');
	$version = get_entity($version_guid);
	
	
	$area2 = elgg_view('socialcommerce/version_edit',array('version'=>$version,'stores'=>$product));
