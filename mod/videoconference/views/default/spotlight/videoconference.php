...
<div id="spotlight_table" >
   ...
   For more details about this application visit the homepage of the <a href="http://www.videowhisper.com/">VideoWhisper</a>, <a href="http://www.videowhisper.com/?p=Video+Conference">Video Conference Application</a> and <a href="http://www.videowhisper.com/?p=Elgg+Video+Conference">Elgg Video Conference Plugin</a>.
	<?php 
...
<iframe src="http://www.facebook.com/plugins/like.php?app_id=&amp;href=<?echo $currenturl;?>&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>
		<? }
		?>
	</div>
</div>
