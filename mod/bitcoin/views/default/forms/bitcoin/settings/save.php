...
<div class="generatewallet" style="padding:10px; border: 1px dotted #ccc;">
	...
	<input type="password" id="bitcoin_generate_password" name="password"/></p>
    <input id="bitcoin_generate_wallet" type="submit" name="generate" value="Generate new system wallet" class="elgg-button elgg-button-action"/>
</div>
