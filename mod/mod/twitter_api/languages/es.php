<?php
/**
 * Spanish language pack for Twitter api module
  * Author: Davod
 */
...
$spanish = array(
	...
	'twitter_api:login' => '&iquest;Permitir a los usuarios existentes que se han conectado a su cuenta de Twitter para iniciar sesión con Twitter?',
