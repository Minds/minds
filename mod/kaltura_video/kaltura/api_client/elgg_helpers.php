...
function kaltura_get_metadata($entity) {
	...
	if(elgg_get_plugin_setting("enablerating","kaltura_video") == 'no') $ob->kaltura_video_rating_on = 'Off';
...
function kaltura_create_generic_widget_html ( $entryId , $size='l' , $version=null , $version_kshow_name=null , $version_kshow_description=null)
{
	...
	$video_location = 'http://www.minds.tv/index.php/kwidget/wid/_100/uiconf_id/' . $widgetUi . '/entry_id/'. $entryForPlayer;
	
	$widget .= '<script type="text/javascript" src="http://www.minds.tv/p/100/sp/10000/embedIframeJs/uiconf_id/'.$widgetUi.'/partner_id/100"></script>';
