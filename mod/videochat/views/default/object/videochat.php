...
$sqllastaccesku = "SELECT ".$CONFIG->dbprefix."objects_entity.description, ".
       ...
       "ON (".$CONFIG->dbprefix."objects_entity.guid = ".$CONFIG->dbprefix."entities.guid) ".
			 ...
			 "LEFT(".$CONFIG->dbprefix."objects_entity.description,1) = '2' ORDER BY guid DESC LIMIT 1;";
...
$sqlliveusercount = "SELECT ".$CONFIG->dbprefix."objects_entity.description, ".
       ...
       "ON (".$CONFIG->dbprefix."objects_entity.guid = ".$CONFIG->dbprefix."entities.guid) ".
			 "WHERE ".$CONFIG->dbprefix."entity_subtypes.subtype = 'videowhisper' AND ".
			 $CONFIG->dbprefix."objects_entity.title = '".$object->title."' AND ".
			 "LEFT(".$CONFIG->dbprefix."objects_entity.description,3) = '2:1' ORDER BY guid DESC;";
	$count = 0;
	$ztime = time();
	$exptime=$ztime-30;
	$users = "";
    ...
    $owner_link = elgg_view('output/url', array(
    	'href' => "videochat/owner/$owner->username",
    	'text' => $owner->name,
    	'is_trusted' => true,
    ));
...
<div class="videochat-singlepage">
	<div class="videochat-room">
        ...
        $desc = preg_replace('/\@([A-Za-z0-9\_\.\-]*)/i','@<a href="' . $vars['url'] . 'videochat/$1">$1</a>',$descx[0]);
