...
function translationbrowser_init()
{
    ...
    $access = 'admin';
    elgg_register_action ("translationbrowser/get_text", $CONFIG->pluginspath . "translationbrowser/actions/translationbrowser/get_text.php", $access);
    elgg_register_action ("translationbrowser/translate", $CONFIG->pluginspath . "translationbrowser/actions/translationbrowser/translate.php",$access);
}
