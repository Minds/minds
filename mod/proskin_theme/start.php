...
function proSkin_theme_init() {
	...
	elgg_register_page_handler('thanks', 'proSkin_theme_credits_handler');
	...
	elgg_extend_view('css/elgg', 'proSkin_theme/css');
...
function proSkin_theme_credits_handler() {
...
elgg_register_event_handler('init', 'system', 'proSkin_theme_init');