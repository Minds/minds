...
/* ***************************************
	Tables
*************************************** */
.elgg-table td,.elgg-table th{border:1px solid #646464;padding:4px 8px;}.elgg-table th{background-color:#363636;}.elgg-table tr:nth-child(odd),.elgg-table tr.odd{background-color:#fff;}.elgg-table tr:nth-child(even),.elgg-table tr.even{background-color:#f0f0f0;}.elgg-table-alt td{border-bottom:1px solid #646464;padding:2px 4px;}.elgg-table-alt td:first-child{width:200px;}.elgg-table-alt tr:hover{background:#E4E4E4;}.elgg-table,.elgg-table-alt{width:100%;border-top:1px solid #ccc;}
/* ***************************************
	Owner Block
*************************************** */
...
/* MISCELLANEOUS */
.elgg-photo {border: 1px solid #5f5f61;padding: 3px;background-color: white;}.elgg-comments {margin-top: 25px;}.elgg-comments > form {margin-top: 15px;}