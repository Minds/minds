 ...
 * Elgg V1.8.1-V1.8.3, V1.8.13, Traduit par Jean-Baptiste Duclos.
...
/* Ajout Jean-Baptiste Duclos */
/**
 * footer
 */
	'Installinstructions' => "Instructions d'installation",
	'Installtroubleshooting' => "Problèmes d'installation",
	'ElggCommunityForums' => "Forums communauté d'Elgg",
/**
 * Address http footer
 */
	'AddressInstallinstructions' => "http://docs.elgg.org/wiki/Installation_fr",
	'AddressInstalltroubleshooting' => "http://docs.elgg.org/wiki/Install_Troubleshooting_fr",
	'AddressElggCommunityForums' => "http://community.elgg.org/pg/groups/world",
/**
 * installation
 */
);
